<nav class="sidebar">
    ...
    <ul id="sidebar_menu">
        ...
        <li class="">
            <a wire:navigate href="{{url('/admin/who-we-are')}}"  aria-expanded="false">
                <div class="nav_icon_small">
        ...
        <li class="">
            <a wire:navigate href="{{ url('/admin/maintenance') }}" aria-expanded="false">
              <div class="nav_icon_small">
                  <img src="{{asset('img/menu-icon/dashboard.svg')}}" alt="">
              </div>
              <div class="nav_title">
        ...
        <li class="">
            <a wire:navigate href="{{ url('/admin/focus-areas') }}" aria-expanded="false">
              <div class="nav_icon_small">
                  <img src="{{asset('img/menu-icon/6.svg')}}" alt="">
              </div>
              <div class="nav_title">
        ...
        <li class="">
            <a wire:navigate href="{{ url('/admin/gallery') }}" aria-expanded="false">
              <div class="nav_icon_small">
                  <img src="{{asset('img/menu-icon/21.svg')}}" alt="">
              </div>
              <div class="nav_title">
