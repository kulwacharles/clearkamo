<div>
    ...
    <div class="modal fade" id="addCoreValueModal" tabindex="-1" role="dialog" aria-hidden="true" wire:ignore.self>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control" wire:model="title" placeholder="e.g. Community-centred">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" wire:model="details" rows="3" placeholder="Additional details about this core value."></textarea>
                            @error('details') <span class="text-danger small">{{ $message }}</span> @enderror
                        </div>

                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label class="form-label">Font Awesome Icon <span class="text-muted">(e.g. fa-users)</span></label>
                                <input type="text" class="form-control" wire:model="icon" placeholder="fa-users">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Photo <span class="text-muted">(optional, up to 10 MB — replaces icon on card)</span></label>
    ...
    <div class="modal fade" id="editCoreValueModal" tabindex="-1" role="dialog" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form wire:submit.prevent="update" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Photo <span class="text-muted">(leave blank to keep current, up to 10 MB)</span></label>
                            @if($currentImage)
                                <div class="mb-2">
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            Livewire.on('editCoreValueItem', (event) => {
                @this.editItem(event.id);
            });

            Livewire.on('deleteCoreValueItem', (event) => {
