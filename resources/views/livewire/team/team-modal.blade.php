        ...
        <div class="modal-content">
            ...
            <form wire:submit.prevent="store" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" wire:model="salutation">
                            @error('salutation') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">Save Slide</button>
                </div>
            </form>
        </div>
    </div>
