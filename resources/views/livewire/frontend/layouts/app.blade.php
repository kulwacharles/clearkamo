...
<head>
    ...
    <title>@yield('title','ClearKamo')</title>
    ...
    <meta property="og:image" content="{{ $image ?? asset('assets/img/og-image.jpg') }}">
  ...
  <div class="cta-area-1">
    <div class="container z-index-common">
        <div class="cta-wrap bg-theme">
            ...
            <a wire:navigate href="{{ route('business-inquiry') }}" class="th-btn style7">Read More
