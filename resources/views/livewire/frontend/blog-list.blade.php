            ...
            <div class="row gx-40"> 
                ...
                <div class="col-xxl-8 col-lg-7">
                   @foreach ($blogs as $blog)
                        ...
                        <div class="blog-img">
                            <a wire:navigate href="/news-and-updates/details/{{ $blog->slug }}">
                                <img src="{{ asset('storage/'.$blog->image) }}" alt="Blog Image">
                            </a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="/news-and-updates/details/{{ $blog->slug }}">
                            ...
                            <h2 class="blog-title">
                                <a wire:navigate href="/news-and-updates/details/{{ $blog->slug }}">{{$blog->title}}</a>
                            </h2>
                            <p class="blog-text">
                               {{ \Illuminate\Support\Str::limit(html_entity_decode(strip_tags($blog->description)), 350, '...') }}

                            </p>
                            <a wire:navigate href="/news-and-updates/details/{{ $blog->slug }}" class="th-btn">Read More
                                <div class="icon">
                            ...
                            <div class="recent-post-wrap">
                                @if($recents)
                                    ...
                                    <div class="recent-post">
                                        <div class="media-img">
                                            <a wire:navigate href="/news-and-updates/details/{{ $recent->slug }}">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <h4 class="post-title">
                                                <a wire:navigate class="text-inherit" href="/news-and-updates/details/{{ $recent->slug }}">{{ $recent->title }}</a>
                                            </h4>
                                        </div>
                                    </div>  
                                    @endforeach
